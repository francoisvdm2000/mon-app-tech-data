...
class _AboutReseauPageState extends State<AboutReseauPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final toc = <_TocEntry>[
      _TocEntry('1) Bases réseau (LAN / IP / débit)', _kBasics),
      _TocEntry('2) RJ45 & catégories (Cat5e/6/6A/…)', _kRj45),
      _TocEntry('3) PoE (alimentation réseau)', _kPoE),
      _TocEntry('4) Fibre (SM/MM) + connecteurs (LC/SC)', _kFiber),
      _TocEntry('5) SFP / SFP+ / QSFP (modules)', _kSfp),
      _TocEntry('6) Switches (VLAN / IGMP / QoS)', _kSwitch),
      _TocEntry('7) Art-Net / sACN sur réseau (conseils)', _kArtNetSacn),
      _TocEntry('8) Checklist', _kChecklist),
    ];
